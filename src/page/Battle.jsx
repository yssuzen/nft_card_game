...
const Battle = () => {
    ...
    useEffect(() => {
        const getPlayerInfo = async () => {
            try {
                ...
                if(gameData.activateBattle.players[0].toLowerCase() === walletAddress.toLowerCase()){
                    player01Address = gameData.activateBattle.players[0];
                    player02Address = gameData.activateBattle.players[1];
                }else{
                    player01Address = gameData.activateBattle.players[1];
                    player02Address = gameData.activateBattle.players[0];
                }
        ...
        if(contract && gameData.activateBattle) getPlayerInfo();
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            if(!gameData?.activateBattle) navigate('/');
        }, [2000])
